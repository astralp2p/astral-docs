...
* Protocols
  ...
  * [mcp](protocols/mcp/README.md) - AI agent registration and the MCP endpoint serving agents their mail and the deployment's declared tools
...
* Other topics
  * Narratives
    ...
    * [App Routing](topics/app-routing.md) - how a query addressed to an app reaches it, on its own node and on another
