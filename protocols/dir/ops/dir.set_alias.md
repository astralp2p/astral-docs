...
* identity (string8, required) – The identity to set the alias for, given as a
...
```shellsession
$ astral-query dir.set_alias -identity 0282fee8775757cdd8fda8b220195f5b8611312cd145c5a1a3aa55df210e779b2c -alias somealias -out text
#[ack] 
```
...
```shellsession
$ astral-query dir.set_alias -identity 0282fee8775757cdd8fda8b220195f5b8611312cd145c5a1a3aa55df210e779b2c -alias "" -out text
#[ack] 
```
